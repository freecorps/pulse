        ...
        <CardContent>
          <ScrollArea className="h-[600px] pr-4">
            <div className="space-y-4">
              <p>
                A sua privacidade é importante para nós. É política do Pulse
              ...
              <p>
                ...
                informação que o Pulse oferece no site e com caráter
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>
                  ...
                  (softwares) do Pulse, de seus fornecedores ou terceiros, para
              ...
              <p>Esta política é efetiva a partir de 17 October 2024 03:25</p>
            </div>
          </ScrollArea>
        </CardContent>
      </Card>
